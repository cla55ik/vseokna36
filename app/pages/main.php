...
<main class="container-fluid  p-0">
  <div class="container-fluid main-okna p-0">
    <div class="container main-okna-content ">
      <div class="col-lg-7 h1-block">
        <h1>
          <span class="gray first d-block">Пластиковые окнa</span>
    ...
    <div class="container p-0">
      <div class="container d-flex bg-light main-child p-0">
        ...
        <div class="col-lg-7 second">
          <h2 class="mb-5">
            <span class="gray first title-42">ОБЪЯВЛЯЕМ ГОД</span>
            <span class="gray second title-32">ДЕТСКОЙ&nbsp;БЕЗОПАСНОСТИ</span>
          </h2>
          <div class="d-flex justify-content-between align-items-center">
            ...
            <h3 class="pink text-32">
              ручка с замком<br />
              <span class="title-32">В ПОДАРОК</span><br />
              к каждому окну
            </h3>
  ...
  <div class="container p-0 auth-partner pt-100 pb-100 gray">
    <h2 class="title-42">АВТОРИЗОВАННЫЙ ПАРТНЕР REHAU</h2>
    <div class="row">
