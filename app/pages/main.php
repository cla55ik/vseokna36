...
<main class="container-fluid  p-0">
  <div class="container-fluid main-okna p-0">
    <div class="container main-okna-content ">
      <div class="col-lg-7 h1-block">
        <h1>
          <span class="first d-block">Пластиковые окнa</span>
          <span class="pink text-uppercase d-block">Rehau</span>
          <span class="second d-block">от завода в Воронеже</span>
        </h1>
  ...
  <div class="container p-0 auth-partner pt-100 pb-100">
    <h2 class="title-42 mt-100">АВТОРИЗОВАННЫЙ ПАРТНЕР REHAU</h2>
    <div class="row">
  ...
  <div class="container pb-70">
    ...
    <div class="row calculator">
      <div class="container d-flex calculator pt-70">
        <div class="col-lg-8">
