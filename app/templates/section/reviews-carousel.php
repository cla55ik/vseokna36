...
<div class="d-block d-md-none container reviews-wrapper mb-100 mt-100" id="reviews-mob">

  <div class=" row mb-30">
      <div class="col-lg-8">
        <h2 class="title-32">ОТЗЫВЫ НАШИХ КЛИЕНТОВ</h2>
      </div>
      <div class="col-lg-4 d-flex justify-content-end control-button-review">
  ...
  <div class="row justify-content-between mb-50 review-slider-wrapper">
    <div class="review-card" v-for="(review, index) in reviews" v-show="index===stepIndex">
      <div class="d-flex review-head mb-40">
        <div class="review-img">
          <img class="" :src=review.img alt="">
        </div>
