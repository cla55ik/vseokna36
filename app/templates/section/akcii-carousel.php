...
<!--Mobile-->
<div class="d-block d-md-none container akcii-wrapper mt-100" id="akcii-mob">
    <div class="row akcii-head">
        <div class="col-lg-8 akcii-wrapper-title">
            <h2 class="title-36-cc akcii-wrapper-title">Действующие акции</h2>
        </div>
        <div class="col-lg-4 d-flex justify-content-end control-button">

            <a v-on:click="prev"><img src="/src/img/chevron-left-m.svg" alt="Кнопка назад"></a>
            <a v-on:click="next"> <img src="/src/img/chevron-right-m.svg" alt="Кнопка вперед"> </a>
        </div>

    </div>

    <div class="d-flex col-12 akciya-carousel-wrapper">

        <div class="akciya-card p-0" v-for="(s, index) in stest" v-show="index===stepIndex">
